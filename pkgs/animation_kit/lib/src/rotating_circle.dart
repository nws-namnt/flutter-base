...
/// A shape that flips end-over-end by rotating `180°` around the X axis
/// (ease-in) then `180°` around the Y axis (ease-out) each half of the
/// cycle, giving a continuous tumbling rotation.
class RotatingCircle extends StatefulWidget {
  ...
  /// Color of the circle. Ignored when [itemBuilder] is provided.
  final Color? color;
  ...
  /// filled circle. When provided, [color] should be omitted.
